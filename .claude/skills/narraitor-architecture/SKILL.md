...
## Use design tokens
- Avoid hardcoded colors; use CSS custom properties (`var(--color-*)`, `var(--space-*)`, etc.) defined in the design system.
- Style components with plain CSS and design tokens; use `clsx` for conditional classes.
