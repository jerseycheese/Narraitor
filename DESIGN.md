...
- Storybook: `npm run storybook` (port 6006); foundation stories at [src/stories/00-foundation/](src/stories/00-foundation/) (`DesignSystemShowcase.stories.tsx`, `DesignTokens.stories.tsx`); per-component stories live next to their components or under [src/stories/](src/stories/). The `/dev/design-system{,-2,-3}` showcase pages ADR-011 named as canon are retired (ADR-012) — Storybook is canon.
