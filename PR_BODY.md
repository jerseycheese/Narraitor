## Description
Removed unused file: src/components/GameSession/ActiveGameSession.complex.tsx
...
This removes an unreferenced component. ActiveGameSession.tsx is the canonical component and the only one imported.

## Voice & Writing Profile
The following profile is included to align the PR language and future documentation updates:

<details><summary>View voice-writing-profile.md</summary>
...
- **Transition style:** Organic - uses "Aside from," "Interestingly," "Anyway," contextual flow
...
- Use natural transitions: "which means," varied connectors without repetition
...
- Reference related issues/PRs naturally: "Similar to what I saw in #123"
...
- When explaining: Varied natural openings without repetitive starters, "which" to add detail
...
- When offering alternatives: "Another approach would be..." or "I could also..."

### Solo Developer Perspective
- **Use third person perspective:** "This implements," "The code handles," "The approach taken" - avoid both "we" and "I" language
- **Impersonal ownership:** "The solution," "This approach," "The implementation"
- **Solo context:** Reference past work and decisions without personal pronouns
...
PR: "This addresses the issue where users were getting logged out randomly. 
Turns out I was checking the auth token before it finished loading from storage. 
...
Code review: "This approach makes sense, though I wonder if I could simplify 
