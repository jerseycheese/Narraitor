...
- A failed skill check now costs something instead of quietly undoing the attempt. A 30-turn session that scored 13 of 18 failures as "nothing happened" - the world not moving for ten straight turns - was the evidence ([#1821](https://github.com/jerseycheese/narraitor/issues/1821)).
...
- The world clock's design questions got settled before any code: what makes a thread open, overdue, or resolved, and what forces the story to act on one instead of just mentioning it exists ([#1835](https://github.com/jerseycheese/narraitor/issues/1835)).
...
- The world clock is designed ([#1835](https://github.com/jerseycheese/narraitor/issues/1835)) but not yet built end to end ([#1872](https://github.com/jerseycheese/narraitor/issues/1872), [#1889](https://github.com/jerseycheese/narraitor/issues/1889)).
