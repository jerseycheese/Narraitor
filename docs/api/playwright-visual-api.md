...
```
tests/visual/
├── core-interface.spec.ts
├── core-interface.spec.ts-snapshots/
│   ├── landing-page-full-chromium-darwin.png
│   ├── navigation-header-chromium-darwin.png
│   └── worlds-page-full-chromium-darwin.png
├── game-session-interface.spec.ts
└── game-session-interface.spec.ts-snapshots/
...
npm run test:visual -- tests/visual/core-interface.spec.ts
...
npm run test:visual:update -- tests/visual/core-interface.spec.ts
