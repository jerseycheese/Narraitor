...
- `decision-relevance-scoring.md` documentation
...
### Files Changed
**Deleted:**
- `src/lib/ai/decisionRelevanceCalculator.ts` (442 lines)
- `src/lib/ai/decisionFormatter.ts` (206 lines)
- `src/lib/ai/relevanceDebugger.ts` (137 lines)
- `src/components/devtools/RelevanceDebuggerSection/` (entire folder, 368 lines)
- `docs/features/decision-relevance-scoring.md` (185 lines)
