...
- **Content Rating**: Five levels (G, PG, PG-13, R, NC-17) with specific content guidelines and AI safety integration
- **Narrative Style**: Nine styles including serious, humorous, dramatic, lighthearted, mysterious, action-packed, contemplative, epic, and balanced
- **Language Complexity**: Four levels from simple to literary with detailed vocabulary and sentence structure guidance
- **Custom Instructions**: Additional user-defined tone requirements for specific narrative needs
...
interface ToneSettings {
  ...
  narrativeStyle: 'serious' | 'humorous' | 'dramatic' | 'lighthearted' | 'mysterious' | 'action-packed' | 'contemplative' | 'epic' | 'balanced';
  languageComplexity: 'simple' | 'moderate' | 'advanced' | 'literary';
