...
- **Showcase pages**: [src/app/dev/design-system/page.tsx](../../src/app/dev/design-system/page.tsx) (DS1), `-2/page.tsx` (DS2), `-3/page.tsx` (DS3)
...
- **New component?** Build against tokens, not raw values. Verify in all three showcase pages before merging.
...
- **Fourth theme?** Add `dsN.css`, register it in [src/lib/theme/index.ts](../../src/lib/theme/index.ts), add a showcase page, and update `ThemeProvider`'s `readStoredTheme` validation.
