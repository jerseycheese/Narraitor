...
- **Functional color system.** Orange for active/in‑progress states, Zinc/Slate neutrals for structure; avoid decorative color use.
...
- **Canvas.** Zinc‑50 in light mode or Zinc‑950 in dark mode.
...
- **Typography.** Serif for story text, monospace for system data, sans‑serif for interface chrome.
