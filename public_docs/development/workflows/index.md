...
- `./scripts/github/check-related-issues.sh` - Analyze related issues and dependency risk
- `./scripts/github/analyze-closable-issues.sh` - Identify issues that can be safely closed
- `./scripts/github/update-related-issues.js` - Keep related-issue links in sync
