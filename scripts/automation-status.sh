...
echo -e "┌─────────────────────────────────────────────────────────────┐"
echo -e "│ ${GREEN}1. Standard Mode${NC} (with manual verification)                │"
echo -e "│    └─ ${YELLOW}claude > /project:do-issue-auto 501${NC}                 │"
echo -e "│                                                             │"
echo -e "│ ${GREEN}2. No-Verify Mode${NC} (automated verification)                │"
...
echo -e "│    └─ 🐳 Uses No-Verify mode in Docker container          │"
echo -e "└─────────────────────────────────────────────────────────────┘"
