...
sed -i '' 's/do-issue-auto-batched/do-issue-auto/g' "$CLAUDE_COMMANDS_DIR/do-continuous-issues.md"
...
echo "  /project:do-issue-auto 123         # Auto mode with automated verification"
