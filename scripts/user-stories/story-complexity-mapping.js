...
export const storyMappings = {
  ...
  'ai-service': {
    'generate narrative content': { complexity: 'Large', priority: 'High' },
    'create meaningful decision options': { complexity: 'Medium', priority: 'High' },
    'character development assistance': { complexity: 'Medium', priority: 'Medium' },
    'format AI responses': { complexity: 'Small', priority: 'High' },
    'restart generation': { complexity: 'Small', priority: 'Medium' },
    'continue playing with fallback content': { complexity: 'Medium', priority: 'High' },
    'automatically retry failed requests': { complexity: 'Medium', priority: 'High' },
    'see friendly error messages': { complexity: 'Small', priority: 'High' },
    'include examples in prompts': { complexity: 'Small', priority: 'Medium' },
    'optimize prompts for token efficiency': { complexity: 'Medium', priority: 'Medium' },
    'include world and character context': { complexity: 'Medium', priority: 'High' },
    'define effective prompt templates': { complexity: 'Medium', priority: 'High' }
  },

  'world-interface': {
    'view all my created worlds': { complexity: 'Small', priority: 'High' },
    'see basic information about': { complexity: 'Small', priority: 'High' },
    'set attribute ranges': { complexity: 'Medium', priority: 'High' },
    'edit attributes after creation': { complexity: 'Medium', priority: 'Medium' },
    'edit existing worlds': { complexity: 'Medium', priority: 'Medium' },
    'delete worlds': { complexity: 'Small', priority: 'Medium' },
    'define skill ranges': { complexity: 'Medium', priority: 'High' }
  }
};
