...
export default function DevStandalonePage() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-4">Development Test Harnesses (Standalone)</h1>
      <div className="space-y-2">
        ...
        <Link href="/standalone/template-selector" className="block p-4 bg-blue-100 hover:bg-blue-200 rounded">
          Template Selector Test Harness (Standalone)
        </Link>
      </div>
    </div>
  );
