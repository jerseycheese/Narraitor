...
const MOCK_ENDINGS: Record<string, StoryEnding> = {
  triumphant: {
    ...
    type: 'story-complete',
    tone: 'triumphant',
    epilogue: `As the sun set over the kingdom of Eldoria, Aria Stormblade stood atop the highest tower of the royal castle, her sword finally at rest.

The dark lord had fallen, his armies scattered to the winds, and peace had returned to the realm. The scars of battle marked both the land and its people, but they were healing. In the distance, she could see farmers returning to their fields, merchants reopening their shops, and children playing in the streets once more.

The long nightmare was over. Aria smiled as she felt the weight of her destiny finally lifting from her shoulders. She had found the redemption she sought, not in the glory of victory, but in the simple joy of seeing her people safe and free.`,
    characterLegacy: `Aria Stormblade would be remembered not just as the warrior who defeated the dark lord, but as the hero who chose mercy over vengeance.

Tales of her final confrontation would be sung for generations - how she offered her fallen enemy a chance at redemption, even in his darkest hour. Her name became synonymous with honor and courage throughout Eldoria.

Young warriors would train in her footsteps, and her teachings about finding strength in compassion would shape the kingdom's values for centuries to come.`,
    worldImpact: `The defeat of the dark lord marked the beginning of a new golden age for Eldoria. With the of evil lifted, the realm flourished like never before.

Magic and technology advanced hand in hand, creating wonders that benefited all citizens, not just the privileged few. The alliances forged during the dark times grew stronger, uniting neighboring kingdoms in lasting peace.

Eldoria became a beacon of hope for other realms struggling against their own darkness, proving that even the deepest shadows could be overcome through courage and unity.`,
    timestamp: new Date(),
  ...
  tragic: {
    ...
    type: 'story-complete',
    tone: 'tragic',
    epilogue: `The price of victory was everything. As Aria struck the killing blow against the dark lord, she felt her own life force being drawn away - the ancient magic demanded a soul for a soul, a truth the prophecies had in their cryptic verses.

She collapsed beside her fallen enemy, her strength ebbing like the tide. Around her, the armies crumbled to dust, and the cursed lands began to heal. The kingdom was saved, but its savior would not live to see the peace she had bought with her blood.
...
Her story was told to children as both inspiration and warning - that heroism sometimes demands everything, but that such sacrifice is what separates the truly great from the merely ambitious. Schools were built in her name, teaching that service to others is the highest calling.`,
    worldImpact: `Eldoria emerged from the war transformed by sacrifice. The kingdom became a realm where selflessness was the highest virtue, where leaders were chosen not for their ambition but for their willingness to serve others before themselves.
...
A new order rose from the ashes, one dedicated to ensuring that no future hero would have to pay the price that Aria paid. The realm's scholars worked tirelessly to find ways to break such cruel magics, vowing that her sacrifice would be the last of its kind.`,
  ...
  mysterious: {
    ...
    type: 'story-complete',
    tone: 'mysterious',
    epilogue: `The final battle ended not with clash of steel, but with whispered words in an ancient tongue. As the dark lord fell, his form began to shimmer and fade, revealing something impossible - he bore Aria's own face, twisted by and time.

"You understand now," he gasped with his final breath. "We are two sides of the same coin, forged in different fires." Aria felt reality shift around her as memories that weren't her own flooded her mind.

The victory was complete, but the truth it revealed opened doors to questions she wasn't sure she wanted answered. The prophecy spoke of a chosen one, but it never mentioned what happened after the choosing was done.`,
    characterLegacy: `The full truth of Aria Stormblade's destiny remained shrouded in mystery. Some claimed she ascended to become a guardian between worlds.

Others whispered that she ventured into the spaces between realities, seeking answers to the riddle of her existence. Her legend grew in the telling, becoming more myth than history.

What was certain was that her sacrifice had meaning beyond the simple defeat of evil - she had stepped into a larger pattern, one that touched the very foundations of existence itself.`,
...
The realm became a center of learning for those seeking to understand the deeper mysteries of existence. What had seemed like a simple tale of good versus evil revealed itself as one thread in an incomprehensible tapestry that spanned worlds and ages.`,
  ...
  hopeful: {
    ...
    type: 'story-complete',
    tone: 'hopeful',
    epilogue: `The dark lord's defeat was only the beginning. As his lifted from the land, Aria discovered that the true magic of Eldoria wasn't in ancient spells or mighty weapons - it was in the connections between people, the bonds that had grown stronger in the darkness.
...
"Our greatest victories," she announced to the cheering crowd, "are not the enemies we defeat, but the friends we lift up along the way." The future stretched before them, bright with possibility and rich with the promise of adventures yet to come.`,
    characterLegacy: `Aria Stormblade's greatest achievement wasn't defeating the dark lord - it was showing an entire kingdom how to beyond their need for heroes.

She became the realm's first Teacher-Guardian, establishing schools where young people learned not just to fight, but to dream, create, and build. Her methods spread to other kingdoms, sparking a renaissance of learning and growth.

The warrior who had saved one world became the teacher who helped countless others save themselves, proving that the most powerful magic is the ability to inspire others to greatness.`,
