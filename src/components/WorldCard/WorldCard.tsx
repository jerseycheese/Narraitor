      ...
      <div className="p-4 flex-grow flex flex-col">
        ...
        <div className="flex-grow">
          ...
          {world.universeReference && (
            <div className="mt-2">
              <span 
                data-testid="world-card-universe" 
                className="inline-flex items-center gap-1 text-xs text-purple-700 bg-purple-50 px-2 py-1 rounded-md border border-purple-200"
              >
