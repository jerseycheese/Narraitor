          ...
          <div className="bg-slate-700/50 p-4 rounded-lg border border-slate-600">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-slate-600/30 p-3 rounded border border-slate-500">
                <h4 className="text-sm font-medium mb-2 text-slate-200">AI Response Mocking</h4>
                <Story />
              </div>
              {/* Simulated other sections */}
              <div className="bg-slate-600/30 p-3 rounded border border-slate-500 opacity-50">
                <h4 className="text-sm font-medium mb-2 text-slate-200">AI Testing Panel</h4>
                <div className="text-xs text-slate-400">Other DevTools sections...</div>
              </div>
            </div>
          </div>
        </div>
