...
export const DevToolsPanel = () => {
  ...
  return (
    <div 
      ...
      className={`bg-slate-800 border-t-2 border-slate-600 overflow-hidden ${
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              {(isSectionVisible(SectionId.AI_TESTING) || 
                ...
                isSectionVisible(SectionId.MOCK_CONTROLS) ||
                ...
                <div className="bg-slate-700/50 p-4 rounded-lg border border-slate-600">
                  ...
                  <div className="space-y-3">
                    ...
                    {isSectionVisible(SectionId.MOCK_CONTROLS) && (
                      <CollapsibleSection title="Mock AI Responses" initialCollapsed={true}>
                        <MockControlsSection />
                      </CollapsibleSection>
                    )}
