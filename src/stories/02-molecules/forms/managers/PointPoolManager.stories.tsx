...
import { PointPoolManager, PointAllocation, PointPoolConfig, PointPoolManagerProps } from '@/components/shared/PointPoolManager/PointPoolManager';

const meta: Meta<typeof PointPoolManager> = {
  title: '02-Molecules/forms/managers/PointPoolManager',
