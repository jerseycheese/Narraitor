  ...
  await page.evaluate(() => {
    ...
    const cyberpunkItems = {
      'inventory-ghostlink-cyberdeck': {
        ...
        image: {
          type: 'ai-generated',
          url: '/visual-assets/fixtures/item-ghostlink-cyberdeck.png',
      ...
      'inventory-neuro-stims': {
        ...
        image: {
          type: 'ai-generated',
          url: '/visual-assets/fixtures/item-neuroboost-stims.png',
      ...
      'inventory-black-ice-shard': {
        ...
        image: {
          type: 'ai-generated',
          url: '/visual-assets/fixtures/item-black-ice-shard.png',
